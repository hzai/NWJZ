...
import {checkOrder, checkAppointment, expirePreappointment, expireCoupon, couponReminder} from './schedule';
import {expire_preappointment_reminder} from './reminder'
...
// });
// // 处理过期优惠券 // TODO 确定多少分钟执行一次
// schedule.scheduleJob('*/60 * * * *', function(){
//   expireCoupon()
// });
// // 优惠券过期提醒 每天中午12：00 执行一次
...
// schedule.scheduleJob('0 0 20 * * 0', function(){
