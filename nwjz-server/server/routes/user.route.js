 ...
 * @Last Modified time: 2018-08-20 21:17:52
 */
...
router.route('/company/:userId')
  .put(authRequired, roles('admin'), userCtrl.updateCompanyUser);
// -------------------------------  company ----------------------------------


router.route('/me')
  .get(authRequired, userCtrl.me);
...
router.route('/invited')
  .get(authRequired, userCtrl.getMyInviteList);

router.route('/inviter/:inviterId/:eventId')
  .get(userCtrl.getInviteInfo);

router.route('/msgs')
  .get(authRequired, messageCtrl.list)

router.route('/couponbycode')
...
router.route('/:userId')
  ...
  .put(authRequired, roles('user'), validate(paramValidation.updateUser), userCtrl.update)
