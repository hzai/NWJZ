<template>
  <div class="createPost-container">
    <div style="margin-top:-15px;margin-bottom:10px;">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="dialogFormVisible = true">添加老师评价</el-button>
    </div>
      ...
      <div style="margin:0 auto;">
        <el-form :model="form" label-width="100px" :label-position="right">
          <el-form-item label="工作技能">
            <el-rate v-model="value2" :colors="['#99A9BF', '#F7BA2A', '#FF9900']" show-text :texts="['非常不满','不满意','一般','满意','非常满意',]" />
          </el-form-item>
