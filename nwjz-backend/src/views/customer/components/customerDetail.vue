<template>
  <div class="createPost-container">
    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" label-width="78px" label-position="right" size="medium">
          ...
          <el-row style="padding-left:30px;">
            <el-col :span="8">
              <el-form-item label="客户需求" prop="requirements">
                <el-select v-model="postForm.requirements" style="width:235px;" placeholder="请选择">
